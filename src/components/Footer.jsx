...
function Footer() {
  return (
    <footer className="bg-[#0b0314] text-white w-full py-6 sm:py-8">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 sm:space-x-6">
            ...
            <a href="mailto:varunsharma2990@gmail.com"
               className="hover:text-purple-400 transition-colors duration-300">
        ...
        <div className="mt-6 sm:mt-8 mb-4 sm:mb-8 text-center">
          <p className="text-sm sm:text-base text-gray-400">© {new Date().getFullYear()} Varun Sharma. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
